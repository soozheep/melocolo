const SITE_URL = 'https://melocolo.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Melocolo — Sonic Remedy | Soozhee',
        text: 'Melocolo by Soozhee. Sonic Remedy : Audiosensory Resonance | Alien Frequencies.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
